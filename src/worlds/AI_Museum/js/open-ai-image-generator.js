AFRAME.registerComponent("open-ai-image-gen", {
	...
	init: function () {
		...
		CONTEXT.el.addEventListener("click", function () {
			...
			setTimeout(() => { CONTEXT.alertText.setAttribute("text", "value: Loading Image..."); }, 10000);
			setTimeout(() => { CONTEXT.alertText.setAttribute("text", "value: Image Loaded."); }, 12500);
			...
			fetch(
				"https://api.openai.com/v1/images/generations",
				{
					...
					headers: {
						...
						Authorization:
							"Bearer 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",
					},
					body: JSON.stringify({
